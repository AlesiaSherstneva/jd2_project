...
> [!IMPORTANT]
> Получив недавно новые знания и навыки, я поспешила их применить к проекту: переписала Hibernate-конфигурацию с XML на 
> аннотации, а также добавила TransactionManagement. В результате "поломались" тесты, пока что они не работают. Писать 
> тесты для подобной конфигурации я пока не умею, курс по JUnit-тестированию на Udemy.com в планах на ближайшее время.
